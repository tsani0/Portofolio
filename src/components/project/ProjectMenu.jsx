    ...
    <div>
      <div className="flex flex-wrap justify-center">
        <div className="md:w-1/3 mx-5 mb-5 p-4 rounded-2xl border border-white/10 bg-transparent shadow-lg shadow-white/5 backdrop-blur-lg text-gray-300 ">
          <img src="../../public/images/jagoit.png" alt="" className="w-[400px] h-[250px] mx-auto rounded-2xl pb-9" />
        ...
        <div className="md:w-1/3 mx-5 mb-5 p-4 rounded-2xl border border-white/10 bg-transparent shadow-lg shadow-white/5 backdrop-blur-lg text-gray-300">
          <img src="../../public/images/sproutify.png" alt="" className="w-[400px] h-auto mx-auto rounded-2xl pb-9" />
          <h3>SPOURTIFY</h3>
